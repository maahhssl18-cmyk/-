...
<style>{`@import url('https://fonts.googleapis.com/css2?family=Tajawal:wght@400;500;700;800;900&family=Space+Grotesk:wght@700;800&display=swap'); * { box-sizing: border-box; margin: 0; padding: 0; } ::-webkit-scrollbar { width: 4px; } ::-webkit-scrollbar-thumb { background: ${T.neon}44; border-radius: 2px; } button { font-family: 'Tajawal', sans-serif; } input { font-family: 'Tajawal', sans-serif; } .price { direction: ltr; display: inline-block; font-variant-numeric: tabular-nums; }`}</style>
